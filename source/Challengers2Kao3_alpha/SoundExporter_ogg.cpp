...
/* Maksymalna iloœæ ¿¹danych floatów w buforze sampli */
#define GRANICA_FLOAT_BUF 512


////////////////////////////////////////////////////////////////
// Zakoduj i zapisz dane z u¿yciem biblioteki "libvorbis_static"
// "Ogg Vorbis: Encode"
////////////////////////////////////////////////////////////////
int CSoundExporter::encodeWithVorbis()
{
	...
	while (0 == eos)
	{
		/* Wysy³aj bloki po jakieœ 512 Floatów, bo by³y problemy ze stosem */
		/* Ka¿da próbka Stereo ma po 2 kana³y. Razem dostajemy 4096 bajtów. */
