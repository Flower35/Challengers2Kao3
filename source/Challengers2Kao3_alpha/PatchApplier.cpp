...
////////////////////////////////////////////////////////////////
// Konstruktor klasy wstrzykującej patche
////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////
// Dekonstruktor klasy wstrzykującej patche
////////////////////////////////////////////////////////////////
...
void CPatchApplier::aplikujCommonChanges()
{
	...
	/**** Widescreen ****/
	{
		...
		// [loading] Odwołania do "glOrtho()" z "eKao2Gamelet"
	...
	/**** "port_common_cracks.txt" ****/
	{
		...
		// "glutAppMain.cpp" - zmień nazwę okna z "Kangurek Kao: Tajemnica Wulkanu" na "Kao Challengers"
...
int CPatchApplier::aplikujLatke(int id)
{
	try
	{
		/* Sprawdź plik docelowy, jeżeli nie był jeszcze otwierany */
		...
		/* Sprawdź, który patch zaaplikować */
		switch (id)
		{
			...
			case 0x00:
			{
				...
				// "eSwietlikKao" (nieznana przyczyna błędu)
				...
				// Opcja "Nowy wyścig" tylko w poziomie "Wyścig"
			...
			case 0x01:
			{
				...
				// "eUIRacingDataRevEng" (problem ze słowem "owner")
				...
				// Zmniejszenie wielkości nicku gracza (lewa cześć ekranu)
				...
				// @@@ Schowaj większość opcji w Menu Głównym
			...
			default:
			{
				throw EKomunikat(L"Wybrana łatka nie jest jeszcze gotowa...\r\nNIE BIJCIE MNIE !!!");
				return 1;
			}
		}
	}
