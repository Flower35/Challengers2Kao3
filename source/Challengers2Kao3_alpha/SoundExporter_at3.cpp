...
int CSoundExporter::readAt3Format()
{
	...
	/* Odczytaj dziwną liczbę i pomiń dziwne bajty */
	...
	/* Sprawdź ustawienia formatu */
	switch (Wav.Format.wFormatTag)
	{
		case WAVE_FORMAT_PCM:
		{
			/* Nie musimy dokonwać dekompresji :) */
			return 0;
		}
	...
	/* (--dsp--) pierwsza ramka powinna być pominięta??? */
	/* zauważyłem, że jest ona raczej pusta (same 0x0000) */
