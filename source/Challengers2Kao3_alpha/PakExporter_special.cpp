...
////////////////////////////////////////////////////////////////
// Czy dany ITEM można pominąć podczas wypakowywania?
////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////
// Czy za dany ITEM można podstawić inny plik?
////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////
// Sprawdź, czy ITEM powinien mieć zmienioną nazwę
////////////////////////////////////////////////////////////////
void CPakExporter::opracujKoncowaNazweItema(int32_t &typ, int32_t &podtyp, eUnicodeString &nazwa)
{
	...
	if (CWindow::czyJestOpcjaZaawansowana(OPCJA_ZAAWANSOWANA_DECOMPRESS_SFX))
	{
		...
		if (ITEM_RODZAJ_DZWIEKOWY == typ)
		{
			...
			if (nullptr != new_ext)
			{
				/* Docelowy wskaźnik jest  automatycznie liczony jako "wchar_t*" (nie trzeba mnożyć przez 2) */
				std::memcpy(
...
int CPakExporter::eksportujItemSubfunkcja(int rozmiar, int offset_koncowy, eUnicodeString &nazwa)
{
	...
	/* Czy plik można pominąć, ze względu na silnik "Tajemnicy Wulkanu"? */
	...
	/* Czy dany plik można podmienić poprzez kopiowanie? */
	...
	/* Czy plik musi mieć zmienioną nazwę? */
	opracujKoncowaNazweItema(typ_pliku, podtyp_pliku, nazwa);

	/* Czy dany rodzaj itemu będzie wymagał utworzenia pełnej ścieżki? */
	switch (typ_pliku)
	{
		...
		default:
		{
			...
			/* Zapamiętaj ścieżkę wynikową wypakowywanego pliku */
			pelna_sciezka_text = pelna_sciezka.getText();

			/* Wyjdź, jeśli docelowy plik już istnieje */
	...
	switch (typ_pliku)
	{
		case ITEM_RODZAJ_GRAFICZNY:
		{
			...
			if (bmpEx.wykonajZadanie(0))
			{
				...
				/* Nazwę Bitmapy możemy sprawdzić dopiero po jej odczytaniu */
				if (CWindow::czyJestOpcjaZaawansowana(OPCJA_ZAAWANSOWANA_UPGRADABLES))
				{
